...
CREATE INDEX IF NOT EXISTS idx_orders_purchase_date ON raw.orders(order_purchase_timestamp);
...
CREATE INDEX IF NOT EXISTS idx_reviews_score ON raw.order_reviews(review_score);
CREATE INDEX IF NOT EXISTS idx_geolocation_zip ON raw.geolocation(geolocation_zip_code_prefix);